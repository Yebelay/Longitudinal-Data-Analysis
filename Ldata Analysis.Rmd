...
---
```{r, message=FALSE, warning=FALSE}
# Extracting fixed effects coefficients and their significance
coef_summary <- summary(glmmFit)$coefficients

# Extracting variance components for random effects
variance_components <- VarCorr(glmmFit)
...
- Likelihood inference inherently handles data that are missing
  at random optimally (see lecture 6).
